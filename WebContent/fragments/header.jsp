        ...
        <ul class="nav navbar-nav">
            <c:choose>
                <c:when test="${'admin' eq sessionScope.usertype}">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Gestione libri <span class="caret"></span></a>
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Gestione ordini <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                ...
                <c:otherwise>
                    ...
                    <li class="dropdown" id="generi-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Generi <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="ProductListServlet?type=mobile">Mobiles</a></li>
