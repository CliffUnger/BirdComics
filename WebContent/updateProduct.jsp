...
<body>
    ...
    <div class="container">
        <div class="row"
            ...
            <form name="updateProductForm" action="./UpdateProductSrv" method="post"
                class="col-md-6 col-md-offset-3" onsubmit="return validateUpdateProductForm()">
                ...
                <div class="row text-center">
                    <div class="col-md-4" style="margin-bottom: 2px;">
                        <button formaction="adminStock.jsp" class="btn btn-danger">Cancel</button>
                    </div>
                    <div class="col-md-4">
