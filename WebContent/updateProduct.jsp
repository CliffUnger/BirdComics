            ...
            <form action="./UpdateProductSrv" method="post" class="col-md-6 col-md-offset-3">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value="<%= product.getProdName() %>" required>
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" step="0.01" name="price" class="form-control" id="price" value="<%= product.getProdPrice() %>" required>
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="quantity">Stock Quantity</label>
                        <input type="number" name="quantity" class="form-control" id="quantity" value="<%= product.getProdQuantity() %>" required>
                    </div>
                </div>
