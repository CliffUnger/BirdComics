...
//back into the store
public class DemandServiceDAO  {

	
	public boolean addProduct(String userId, String prodId, int demandQty) throws SQLException {
		boolean flag = false;
	...
	public boolean removeProduct(String userId, String prodId) throws SQLException {
		boolean flag = false;
	...
	public boolean addProduct(DemandBean userDemandBean) throws SQLException {

		return addProduct(userDemandBean.getUserName(), userDemandBean.getProdId(), userDemandBean.getDemandQty());
	}

	
	public List<DemandBean> haveDemanded(String prodId) throws SQLException {
